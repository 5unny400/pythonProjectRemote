...
EOF
# 脚本
cat> /home/shell/ikuuu-sign-in.sh <<EOF
curl 'https://ikuuu.me/user/checkin' \
  -X 'POST' \
  -H 'Accept: application/json, text/javascript, */*; q=0.01' \
  -H 'Accept-Language: zh-CN,zh;q=0.9' \
  -H 'Connection: keep-alive' \
  -H 'Content-Length: 0' \
  -H 'Cookie: lang=zh-cn; uid=1756319; email=3407691546%40qq.com; _gid=GA1.2.631930817.1702797151; key=00e61a7e7689d22a7778cb644c36d3d65afafe7c0c431; ip=2e7555bc5ccefad66cf845486a06df76; expire_in=1703401996; _gat_gtag_UA_158605448_1=1; _ga_8HVN7928SC=GS1.1.1702829139.7.1.1702829140.0.0.0; _ga=GA1.1.904219164.1702797145' \
  -H 'Origin: https://ikuuu.me' \
  -H 'Referer: https://ikuuu.me/user' \
  -H 'Sec-Fetch-Dest: empty' \
  -H 'Sec-Fetch-Mode: cors' \
  -H 'Sec-Fetch-Site: same-origin' \
